    ...
    public partial class WeeklyPR : global::System.Data.DataSet {
        ...
        public partial class Weekly2Row : global::System.Data.DataRow {
            ...
            public int ProjectID {
                get {
                    try {
                        return ((int)(this[this.tableWeekly2.ProjectIDColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ProjectID\' in table \'Weekly2\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableWeekly2.ProjectIDColumn] = value;
                }
            }
            ...
            public bool IsProjectIDNull() {
                return this.IsNull(this.tableWeekly2.ProjectIDColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetProjectIDNull() {
                this[this.tableWeekly2.ProjectIDColumn] = global::System.Convert.DBNull;
            }
        }
...
FROM            Weekly INNER JOIN
                         ...
                         Jobs ON Employees.JobID = Jobs.JobID INNER JOIN
                         Departments ON Employees.DepartmentID = Departments.DepartmentID
WHERE        (Weekly.StartAt BETWEEN @Param1 AND @Param2) AND (Departments.DepartmentID = @Param3) AND (Employees.ProjectID = @Param4)";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param2", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "StartAt", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param4", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "ProjectID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
...
WHERE        (Departments.DepartmentID = @Param3)";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param3", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "DepartmentID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = @"SELECT        Weekly.EmployeeName, Employees.BiometricID, Departments.Department_Name, Jobs.JobTitle, Weekly.DayRate, Weekly.StartAt, Weekly.EndAt, Weekly.DaysWorked, Weekly.BasicPay, Weekly.OTRate, Weekly.OTPay, 
                         Weekly.Holiday, Weekly.Adjustments, Weekly.GrossSalary, Weekly.PhilHealth, Weekly.PagIbig, Weekly.LoanOrCA, Weekly.UnderTime, Weekly.Late, Weekly.Others, Weekly.TotalDeductions, Weekly.NetSalary, Weekly.SSS, 
                         Weekly.NoOfOT
FROM            Weekly INNER JOIN
                         Employees ON Employees.BiometricID = Weekly.BiometricID INNER JOIN
...
WHERE        (Weekly.StartAt = @Param1) AND (Weekly.EndAt = @Param2)";
            ...
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param1", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "StartAt", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Param2", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "EndAt", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int GetBy4Params(WeeklyPR.Weekly2DataTable dataTable, string Param1, string Param2, int Param3, global::System.Nullable<int> Param4) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual WeeklyPR.Weekly2DataTable GetDataBy3(string Param1, string Param2, int Param3, global::System.Nullable<int> Param4) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((Param1 == null)) {
                throw new global::System.ArgumentNullException("Param1");
            }
